...
import { Contribution, ContributionHeader, ContributionImage } from '../../styles/project/projectDetailStyle';
  ...
  return (<div>
    <div>
      ...
      <ul>
        ...
        <ContributionImage src="/images/newlearn/메인페이지.gif" loading="lazy" />
        <Contribution>반응형 UI 구현</Contribution>
        <p>styled-components와 분리된 테마 파일을 통하여 다크모드와 라이트모드를 구분하였습니다.</p>
        <p>또한 데스크탑, 태블릿, 모바일 화면에 맞게 반응형 UI를 구현하였습니다.</p>
        <ContributionImage src="/images/newlearn/반응형UI.png" loading="lazy" />
        <Contribution>애니메이션 효과</Contribution>
        ...
        <ContributionImage src="/images/newlearn/다크모드토글.gif" loading="lazy" />
        <Contribution>커스텀 가능한 아바타</Contribution>
        ...
        <ContributionImage src="/images/newlearn/아바타커스텀.gif" loading="lazy" />
        <Contribution>단어 하이라이팅</Contribution>
        ...
        <ContributionImage src="/images/newlearn/단어하이라이팅.gif" loading="lazy" />
      </ul>
    </div>
  </div>
  );
